...
def parse_arguments():
    ...
    parser.add_argument("--b_train", action="store_true", help="Whether to b_train the model")
    ...
    parser.add_argument("--output_dir", default= '/home/sharing/disk3/wangyifan/sujianhua/output', type=str, 
...
def run(args, data, model, logger, debug_args = None):
    ...
    if args.save_results:
        ...
        save_results(args, outputs, debug_args)
...
if __name__ == '__main__':
    ...
    set_seed(original_seed)  # Set initial seed
    ...
    if args.tune:
        debug_args = {k: v for k, v in args.items() if isinstance(v, list)}
        ...
        for result in itertools.product(*debug_args.values()):
            ...
            print(args)
            run(args, data, model, logger, debug_args)
