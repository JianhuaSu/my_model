class Param():
    ...
    def get_hyper_parameters(self, args):
        ...
        hyper_parameters = {
            ...
            'safe1': [0.6,0.7,0.8,0.9], 
            'safe2': [0.6,0.7,0.8,0.9], 
            'neg_weight': [0.6,0.7,0.8,0.9],
            
            'margin': [0.7,0.6,0.8,0.9],
            'p': [2],
            'loss_weight': [1,0.9,0.8],
            'supcon_loss_weight': [0.6,0.7,0.8],
            'triplet_loss_weight': [0.7,0.6,0.5]
