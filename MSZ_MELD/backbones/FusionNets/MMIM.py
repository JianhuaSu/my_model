...
class MMIM(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.text_subnet = BERTEncoder.from_pretrained(args.text_backbone_path, cache_dir = args.cache_path)

        self.visual_enc = RNNEncoder(    # visual
        ...
        self.acoustic_enc = RNNEncoder(   # acoustic
    ...
    def forward(self, text_feats, video_data, audio_data, mode = None):
        """
        ...
        enc_word = self.text_subnet(text_feats) # (batch_size, seq_len, emb_size)
