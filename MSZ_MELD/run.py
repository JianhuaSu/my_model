...
def parse_arguments():
    ...
    parser.add_argument("--text_backbone_path", type=str, default='/home/sharing/disk1/pretrained_embedding/bert/uncased_L-12_H-768_A-12/', help="path.")
    ...
    # /home/sharing/disk2/sjh/intentDataset
    parser.add_argument("--data_path", default = '/home/sharing/disk3/wangyifan/sujianhua/Tools', type=str,
    ...
    parser.add_argument('--cache_path', type=str, default='', 
                        help="The caching directory for pre-trained models.")   
    ...
    parser.add_argument("--output_path", default= '/home/sharing/disk3/wangyifan/sujianhua', type=str, 
...
def set_logger(args):
    ...
    args.logger_name =  f"{args.method}_{args.dataset}_{args.data_mode}_seed-{args.seed}"
