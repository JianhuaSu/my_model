...
class DataManager:
    ...
    def __init__(self, args, logger_name = 'Multimodal Intent Recognition'):
        ...
        self.train_data_index, self.train_label_ids = self._get_indexes_annotations(os.path.join(self.data_path, 'train.tsv'), args.data_mode, args.dataset)
        self.dev_data_index, self.dev_label_ids = self._get_indexes_annotations(os.path.join(self.data_path, 'dev.tsv'), args.data_mode, args.dataset)
        self.test_data_index, self.test_label_ids = self._get_indexes_annotations(os.path.join(self.data_path, 'test.tsv'), args.data_mode, args.dataset)
    ...
    def _get_indexes_annotations(self, read_file_path, data_mode, dataset):
        ...
        with open(read_file_path, 'r') as f:
            ...
            for i, line in enumerate(data):
                ...
                if dataset == 'MIntRec':
                    ...
                    raise ValueError('The input dataset is not supported.')
                ...
                elif dataset in ['MIntRec2', 'MELD-DA']:
