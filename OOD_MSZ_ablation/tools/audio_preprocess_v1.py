        ...
        for season in tqdm(os.listdir(args.raw_video_path), desc = 'Season'):
            ...
            for episode in tqdm(os.listdir(episode_path), desc = 'Episode'):
                ...
                for clip in tqdm(os.listdir(clip_path), desc = 'Clip'):
                    ...
                    name = '_'.join([season, episode, clip])[:-4]
...
if __name__ == '__main__':
    ...
    # dataset = 'TED-OOD'
    args.raw_video_path = '/home/sharing/disk2/Datasets/MIntRec2.0/raw_data'
    args.audio_data_path = '/home/sharing/disk2/Datasets/MIntRec2.0/audio_data'
    args.raw_audio_path = '/home/sharing/disk2/Datasets/MIntRec2.0/audio_data/raw_audio'
    args.audio_feats_path = 'audio_feats.pkl'

    # args.raw_video_path = '/home/sharing/Datasets/EMOTyDA/MELD/raw_data'
    # args.audio_data_path = '/home/sharing/Datasets/EMOTyDA/MELD/audio_data'
    # args.raw_audio_path = '/home/sharing/Datasets/EMOTyDA/MELD/audio_data/raw_audio'
    # args.audio_feats_path = 'audio_feats.pkl'
    # train_file_path = '/home/sharing/disk1/zhanghanlei/Datasets/public/TED-OOD/train.tsv'
    # dev_file_path = '/home/sharing/disk1/zhanghanlei/Datasets/public/TED-OOD/dev.tsv'
    # test_file_path = '/home/sharing/disk1/zhanghanlei/Datasets/public/TED-OOD/test.tsv'
    
    # train_elems = get_elems(train_file_path)
    # dev_elems = get_elems(dev_file_path)
    # test_elems = get_elems(test_file_path)

    # all_elems = train_elems + dev_elems + test_elems
    # print(len(all_elems))

    args.sr = 16000
    audio_data = AudioFeature(args, all_elems)