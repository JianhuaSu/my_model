...
class TEXT:
    ...
    def __init__(self, args, data):
        ...
        self.model = BertForSequenceClassification.from_pretrained(args.text_backbone_path, cache_dir = args.cache_path, num_labels = args.num_labels)
        ...
        self.logger.info("text_data loading complete...")
