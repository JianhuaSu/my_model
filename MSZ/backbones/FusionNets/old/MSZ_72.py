...
class MSZ(nn.Module):
    ...
    def forward(self, text_feats, video_feats, audio_feats, label_ids):
        ...
        t_a_att_con = self.att_ta(fusion_tv, feats_output['text'])['embedding']
        t_v_att_con = self.att_tv(fusion_ta, feats_output['text'])['embedding']

        t_con = self.att_t(feats_output['text'])['embedding']
