...
def parse_arguments():
    ...
    parser.add_argument("--output_path", default= '/home/sharing/disk2/sjh/Outputs/MIntRec', type=str, 
...
def set_logger(args):
    ...
    args.logger_name =  f"{args.method}_{args.dataset}_{args.data_mode}_seed-{args.seed}_{time}"
